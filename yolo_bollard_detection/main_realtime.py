...
ap.add_argument('-c', '--config',
                help='path to yolo config file', default='./yolo-coco/yolov3.cfg')
ap.add_argument('-w', '--weights',
                help='path to yolo pre-trained weights', default='./yolo-coco/yolov3.weights')
ap.add_argument('-cl', '--classes',
                help='path to text file containing class names', default='./yolo-coco/coco.names')
args = ap.parse_args()
